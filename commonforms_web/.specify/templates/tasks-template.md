...
**Tests**: The examples below include test tasks. Tests are REQUIRED — write tests for each user story using pytest and ensure they fail before implementation (TDD).
